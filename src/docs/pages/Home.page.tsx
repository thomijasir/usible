      ...
      <div class="space-y-8">
        <div>
          ...
          <p class="text-xl text-gray-600 dark:text-gray-400 mb-6">
            ...
            development. Install it as a local npm package for shared reuse, or
            copy the source into a project when you need complete ownership.
          </p>
        ...
        <div id="components" class="grid md:grid-cols-2 gap-4">
          ...
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm">
              Build a tarball with <code>build:pack</code> for normal package
              imports, or keep the legacy copy-paste workflow for project-level
              customization.
            </p>
          </div>
        ...
        <div class="p-6 rounded-xl bg-gray-900 text-white">
          ...
          <pre class="text-sm overflow-x-auto">
            <code>{`# Option 1: build a local npm package
bun run build:pack
bun add ./dist-pack/usible-0.0.1.tgz

import 'usible/style.css';
import { Button, Input } from 'usible';

# Option 2: legacy source copy
